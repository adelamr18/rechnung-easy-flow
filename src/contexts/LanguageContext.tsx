...
const translations = {
  de: {
    ...
    'invoice.customer': 'Kundenname (optional)',
    'invoice.service': 'Verkaufte Artikel / Notizen',
    'invoice.amount': 'Betrag',
    'invoice.date': 'Datum',
    'invoice.save': 'Speichern',
    'invoice.saving': 'Wird gespeichert...',
    ...
    'invoice.createdDesc': 'Die Rechnung wurde gespeichert. Ein PDF wird bereitgestellt, sofern Ihr Tarif dies erlaubt.',
    ...
    'invoice.customerPlaceholder': 'Max Mustermann',
    'invoice.amountPlaceholder': '100,00',
    'invoice.vendorPlaceholder': 'Ihr Lieferant',
    'invoice.summaryPrefix': 'Beleg',
    'invoice.itemsLabel': 'Positionen',
    'invoice.summaryTotalLabel': 'Summe',
    'feedback.title': 'Feedback senden',
    'feedback.description': 'Hast du eine Idee oder einen Bug gefunden? Sag Bescheid, damit wir InvoiceEasy verbessern können.',
    'feedback.prompt': 'Welche Funktion würde dich zum Pro-Upgrade bewegen?',
    'feedback.placeholder': 'Teile dein Feedback...',
    'feedback.rating': 'Bewertung (optional)',
    ...
    'invoice.pdfSectionTitle': 'PDF-Erstellung',
    'invoice.pdfSectionSubtitleStarter': 'Erstellen Sie ein einfaches PDF mit allen erfassten Positionen.',
    'invoice.pdfSectionSubtitlePro': 'Nutzen Sie die erweiterte Pro-Vorlage mit hochwertigem Layout.',
    'invoice.pdfSectionSubtitleElite': 'Greifen Sie auf Elite-Vorlagen mit Premium-Branding und Highlights zu.',
    'invoice.templateBasic': 'Einfache Vorlage',
    'invoice.templateAdvanced': 'Erweiterte Vorlage',
    'invoice.templateElite': 'Elite-Vorlage',
    'invoice.generateBasic': 'Einfache PDF generieren',
    'invoice.generateAdvanced': 'Erweiterte PDF generieren',
    'invoice.generateElite': 'Elite-PDF generieren',
    'invoice.pdfGenerating': 'Wird erzeugt...',
    'invoice.pdfDownloading': 'PDF wird heruntergeladen...',
    'invoice.pdfReadyTitle': 'PDF bereit',
    'invoice.pdfReadyDesc': 'Die Rechnung steht als PDF zum Download bereit.',
    'invoice.pdfDownload': 'Neueste PDF herunterladen',
    'invoice.pdfLastTemplate': 'Zuletzt verwendete Vorlage',
    'invoice.pdfAwaitSave': 'Speichern Sie die Rechnung, um die PDF-Erstellung zu aktivieren.',
    'invoice.pdfLockedTitle': 'Erweiterte PDF-Vorlagen freischalten',
    'invoice.pdfLockedDesc': 'Upgrade auf Pro oder Elite, um automatische Abläufe und Premium-Designs zu erhalten.',
    'invoice.upgradeCta': 'Jetzt upgraden',
    'invoiceHistory.title': 'Rechnungsverlauf',
    'invoiceHistory.subtitle': 'Behalten Sie alle erstellten Rechnungen im Blick und laden Sie PDFs jederzeit erneut herunter.',
    'invoiceHistory.empty': 'Noch keine Rechnungen gespeichert',
    'invoiceHistory.emptyDesc': 'Sobald Sie eine Rechnung erstellen, erscheint sie hier.',
    'invoiceHistory.savedOn': 'Gespeichert am',
    'invoiceHistory.downloadMissing': 'Erstellen Sie ein PDF, um diese Rechnung herunterzuladen.',
    'invoiceHistory.loadMore': 'Weitere Rechnungen laden',
    'invoiceHistory.loadingMore': 'Lade weitere...',
    'invoiceHistory.deleteConfirm': 'Möchten Sie diese Rechnung wirklich löschen? Dieser Vorgang kann nicht rückgängig gemacht werden.',
    'invoiceHistory.deleted': 'Die Rechnung wurde gelöscht.',
    ...
    'settings.launchingSoon': 'Startet bald',
    ...
    'settings.eliteFeature3': 'Sichere Archivierung für Audits',
    ...
    'beta.noticeSoft': 'Hinweis: In der kostenlosen Beta kannst du vorübergehend mehr als 5 Rechnungen testen.',
    'beta.noticeStrong': 'Später werden 5 Rechnungen pro Monat im Starter-Plan begrenzt. In der Beta darfst du weiter ausprobieren.',
    'beta.modalTitle': 'Du hast das kostenlose Limit erreicht 🎉',
    'beta.modalSubtitle': 'Wir entwickeln InvoiceEasy und freuen uns über dein Feedback.',
    'beta.feedbackLabel': 'Welche Funktion würde dich zum Pro-Upgrade bewegen?',
    'beta.feedbackPlaceholder': 'Teile deine Gedanken...',
    'beta.sendFeedback': 'Feedback senden',
    'beta.cancel': 'Abbrechen',
    'beta.unlockPrompt': 'Möchtest du die Pro-Version während der Beta kostenlos testen? Keine Kreditkarte nötig.',
    'beta.unlockButton': 'Pro (Beta) freischalten',
    'beta.unlockTitle': 'InvoiceEasy Pro (Beta) – derzeit kostenlos',
    'beta.unlockBody': 'Wir befinden uns noch in der Beta und haben Zahlungen noch nicht aktiviert. Teste die volle Pro-Erfahrung kostenlos und hilf uns bei der Priorisierung.',
    'beta.feedbackThanks': 'Danke für dein Feedback!',
    'settings.unlockProBeta': 'Pro (Beta) freischalten',
    'common.euro': '€',
  ...
  en: {
    ...
    'invoice.customer': 'Customer Name (optional)',
    'invoice.service': 'Items sold / Notes',
    ...
    'invoice.createdDesc': 'The invoice was saved. A PDF download is available when your plan allows it.',
    ...
    'invoice.customerPlaceholder': 'Max Mustermann',
    'invoice.amountPlaceholder': '100.00',
    'invoice.vendorPlaceholder': 'your vendor',
    'invoice.summaryPrefix': 'Receipt',
    'invoice.itemsLabel': 'items',
    'invoice.summaryTotalLabel': 'Total',
    'feedback.title': 'Send Feedback',
    'feedback.description': 'Have an idea or found a bug? Let us know so we can keep improving InvoiceEasy.',
    'feedback.prompt': 'What feature would make you upgrade to Pro?',
    ...
    'invoice.pdfSectionTitle': 'PDF generation',
    'invoice.pdfSectionSubtitleStarter': 'Generate a simple PDF that lists every detected item.',
    'invoice.pdfSectionSubtitlePro': 'Use the advanced Pro template with polished styling and layout.',
    'invoice.pdfSectionSubtitleElite': 'Access elite templates with premium branding and item highlights.',
    'invoice.templateBasic': 'Basic template',
    'invoice.templateAdvanced': 'Advanced template',
    'invoice.templateElite': 'Elite template',
    'invoice.generateBasic': 'Generate basic PDF',
    'invoice.generateAdvanced': 'Generate advanced PDF',
    'invoice.generateElite': 'Generate elite PDF',
    'invoice.pdfGenerating': 'Generating...',
    'invoice.pdfDownloading': 'Downloading PDF...',
    'invoice.pdfReadyTitle': 'PDF ready',
    'invoice.pdfReadyDesc': 'Your invoice PDF is ready to download.',
    'invoice.pdfDownload': 'Download latest PDF',
    'invoice.pdfLastTemplate': 'Last template',
    'invoice.pdfAwaitSave': 'Save the invoice first to unlock PDF generation.',
    'invoice.pdfLockedTitle': 'Unlock advanced PDF templates',
    'invoice.pdfLockedDesc': 'Upgrade to Pro or Elite to automate delivery and access premium designs.',
    'invoice.upgradeCta': 'Upgrade now',
    'invoiceHistory.title': 'Invoice history',
    'invoiceHistory.subtitle': 'Keep track of every invoice you generated and re-download PDFs whenever you need them.',
    'invoiceHistory.empty': 'No invoices saved yet',
    'invoiceHistory.emptyDesc': 'Invoices you create will appear here as soon as you save them.',
    'invoiceHistory.savedOn': 'Saved on',
    'invoiceHistory.downloadMissing': 'Generate a PDF to download this invoice.',
    'invoiceHistory.loadMore': 'Load more invoices',
    'invoiceHistory.loadingMore': 'Loading more...',
    'invoiceHistory.deleteConfirm': 'Delete this invoice? This action cannot be undone.',
    'invoiceHistory.deleted': 'The invoice has been deleted.',
    ...
    'settings.launchingSoon': 'Launching soon',
    ...
    'settings.eliteFeature3': 'Secure audit-ready archives',
    'settings.eliteFeature4': 'Dedicated success manager',
    'beta.noticeSoft': 'Starter beta: future limit 5 invoices per month, keep testing for now!',
    'beta.noticeStrong': 'Beta notice: future limit will be 5 invoices per month. Feel free to keep testing.',
    'beta.modalTitle': 'You’ve reached the free limit 🎉',
    'beta.modalSubtitle': 'We’re building InvoiceEasy and would really love your opinion.',
    'beta.feedbackLabel': 'What feature would make you upgrade to Pro?',
    'beta.feedbackPlaceholder': 'Share your feedback...',
    'beta.sendFeedback': 'Send feedback',
    'beta.cancel': 'Cancel',
    'beta.unlockPrompt': 'Want to try the Pro version for FREE during beta? No credit card needed — just enable it.',
    'beta.unlockButton': 'Unlock Pro (Beta)',
    'beta.unlockTitle': 'InvoiceEasy Pro (Beta) — FREE for now',
    'beta.unlockBody': 'We’re still in beta and haven’t enabled payments yet. Try the full Pro experience for free and help us understand what matters.',
    'beta.feedbackThanks': 'Thank you for the feedback!',
    'settings.unlockProBeta': 'Unlock Pro (Beta)',
  ...
  pl: {
    ...
    'invoice.create': 'Utwórz fakturę', 'invoice.customer': 'Klient (opcjonalnie)', 'invoice.service': 'Sprzedane pozycje / opis', 'invoice.amount': 'Kwota', 'invoice.date': 'Data', 'invoice.save': 'Zapisz', 'invoice.saving': 'Zapisywanie...', 'invoice.generate': 'Generuj PDF', 'invoice.subtitle': 'Nowa faktura dla klientów', 'invoice.legalNotice': 'Informacja prawna:', 'invoice.legalText': 'Faktura zostanie automatycznie oznaczona tekstem zgodnie z § 19 UStG.', 'invoice.creating': 'Tworzenie PDF...', 'invoice.created': 'Faktura utworzona!', 'invoice.createdDesc': 'Faktura została zapisana. PDF będzie dostępny, jeśli plan na to pozwala.',
    ...
    'settings.title': 'Ustawienia', 'settings.subtitle': 'Zarządzaj kontem i subskrypcją', 'settings.accountInfo': 'Informacje o koncie', 'settings.language': 'Język', 'settings.languageLabel': 'Język interfejsu:', 'settings.subscription': 'Subskrypcja', 'settings.currentPlan': 'Aktualny plan', 'settings.upgrade': 'Ulepsz', 'settings.starter': 'Starter', 'settings.elite': 'Elita', 'settings.contact': 'Masz pytania? Skontaktuj się z nami pod adresem', 'settings.free': 'Darmowy', 'settings.pro': 'Pro', 'settings.perMonth': '/miesiąc', 'settings.comingSoon': 'Wkrótce', 'settings.launchingSoon': 'Premiera wkrótce', 'settings.starterFeature1': '5 faktur miesięcznie', 'settings.starterFeature2': '5 przesłanych wydatków', 'settings.starterFeature3': 'Wsparcie e-mail', 'settings.starterFeature4': 'Ręczne pobieranie PDF', 'settings.proFeature1': 'Nieograniczone faktury', 'settings.proFeature2': 'Nieograniczone wydatki', 'settings.proFeature3': 'Zaawansowane szablony PDF', 'settings.proFeature4': 'Priorytetowe wsparcie', 'settings.eliteFeature1': 'Wszystko z planu Pro', 'settings.eliteFeature2': 'Automatyczne kopie zapasowe', 'settings.eliteFeature3': 'Bezpieczne archiwa audytowe', 'settings.eliteFeature4': 'Dedykowany opiekun sukcesu', 'settings.feature1': '5 faktur miesięcznie', 'settings.feature2': '10 przesłanych wydatków', 'settings.feature3': 'Podstawowy eksport PDF', 'settings.feature4': 'Wsparcie email', 'settings.feature5': 'Nieograniczone faktury', 'settings.feature6': 'Nieograniczone wydatki', 'settings.feature7': 'Zaawansowane szablony PDF', 'settings.feature8': 'Automatyczne kopie zapasowe', 'settings.feature9': 'Priorytetowe wsparcie', 'settings.feature10': 'Bezpieczne archiwa audytowe',
